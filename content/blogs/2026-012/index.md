...
_How does the same genome give rise to diverse cell types and gene-expression programs? (Click the figure to see detailed legend)_
...
_Transcription factor ChIP-seq experiments (Click the figure to see detailed legend)_
...
_DNase-seq and ATAC-seq chromatin accessibility experiments (Click the figure to see detailed legend)_
...
_Schematic of the neural network architecture of the BPNet model family (Click the figure to see detailed legend)_
...
_The ENCODE GRAMMAR resource transforms the extensive ENCODE compendium of genome-wide biochemical profiling experiments into predictive models and interpretable regulatory sequence annotations (Click the figure to see detailed legend)_
...
_Train a sequence-to-profile deep learning model (Click the figure to see detailed legend)_
...
_Predict the biochemical effect of unseen sequences and genetic variants (Click the figure to see detailed legend)_
...
_Separate biological signal from assay-specific sequence bias (Click the figure to see detailed legend)_
...
_Estimate the contribution of each base in a query DNA sequences to a model’s prediction of biochemical activity (Click the figure to see detailed legend)_
...
_Discover recurring predictive sequence motifs (Click the figure to see detailed legend)_
...
_Map predictive motif instances  (Click the figure to see detailed legend)_
...
_Unify motifs across models (Click the figure to see detailed legend)_
...
_A distal enhancer of the MYC gene in K562 leukemia cells (Click the figure to see detailed legend)_
...
_Observed and ChromBPNet-predicted chromatin-accessibility profiles at the *MYC* enhancer (Click the figure to see detailed legend)_
...
_Bias-corrected ChromBPNet accessibility profiles at the *MYC* enhancer (Click the figure to see detailed legend)_
...
_Highly concordant sequence-contribution maps reveal shared regulatory features at the *MYC* enhancer (Click the figure to see detailed legend)_
...
_TF ChIP–seq BPNet models link ChromBPNet motif instances to specific TFs at the *MYC* enhancer (Click the figure to see detailed legend)_

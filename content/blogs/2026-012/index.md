...
By integrating evidence from these and many other assays not discussed here, ENCODE has identified over 2.4 million [**candidate cis-regulatory elements (cCREs)**](https://screen.wenglab.org/), in the human genome. A cCRE is a genomic region whose biochemical properties suggest that it may regulate gene expression. The ENCODE consortium recently released a preprint describing the entire compendium developed over two decades including many new datasets and derived analysis products from the fourth and final phase of the project [ENCODE 4](https://www.biorxiv.org/content/10.64898/2026.07.06.731365v1).
...
We describe the main steps of our workflow below. More detailed descriptions are available in the [BPNet](https://doi.org/10.1038/s41588-021-00782-6), [ChromBPNet](https://doi.org/10.1101/2024.12.25.630221), and [ProCapNet](https://doi.org/10.1101/2024.05.28.596138) manuscripts.
...
![Figure: Train a model](BPNet_Fig1.gif "width=600 Train a model to predict experimentally observed signal profiles from local DNA sequence context.")

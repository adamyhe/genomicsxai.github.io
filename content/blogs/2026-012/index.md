...
<p align="center"><em>How does the same genome give rise to diverse cell types and gene-expression programs?.<br>(Click the figure to see detailed legend)</em></p>
...
<p align="center"><em>Transcription factor ChIP-seq experiments.<br>(Click the figure to see detailed legend)</em></p>
...
<p align="center"><em>DNase-seq and ATAC-seq chromatin accessibility experiments.<br>(Click the figure to see detailed legend)</em></p>
...
<p align="center"><em>Schematic of the neural network architecture of the BPNet model family.<br>(Click the figure to see detailed legend)</em></p>
...
<p align="center"><em>The ENCODE GRAMMAR resource transforms the extensive ENCODE compendium of genome-wide biochemical profiling experiments into predictive models and interpretable regulatory sequence annotations.<br>(Click the figure to see detailed legend)</em></p>
...
<p align="center"><em>Train a sequence-to-profile deep learning model.<br>(Click the figure to see detailed legend)</em></p>
...
<p align="center"><em>Predict the biochemical effect of unseen sequences and genetic variants.<br>(Click the figure to see detailed legend)</em></p>
...
<p align="center"><em>Separate biological signal from assay-specific sequence bias.<br>(Click the figure to see detailed legend)</em></p>
...
<p align="center"><em>Estimate the contribution of each base in a query DNA sequences to a model’s prediction of biochemical activity.<br>(Click the figure to see detailed legend)</em></p>
...
<p align="center"><em>Discover recurring predictive sequence motifs.<br>(Click the figure to see detailed legend)</em></p>
...
<p align="center"><em>Map predictive motif instances .<br>(Click the figure to see detailed legend)</em></p>
...
<p align="center"><em>Unify motifs across models.<br>(Click the figure to see detailed legend)</em></p>
...
<p align="center"><em>A distal enhancer of the MYC gene in K562 leukemia cells.<br>(Click the figure to see detailed legend)</em></p>
...
<p align="center"><em>Highly concordant sequence-contribution maps reveal shared regulatory features at the *MYC* enhancer.<br>(Click the figure to see detailed legend)</em></p>

...
<p align="center"><em>How does the same genome give rise to diverse cell types and gene-expression programs? (Click the figure to see detailed legend)</em></p>
...
<p align="center"><em>Transcription factor ChIP-seq experiments (Click the figure to see detailed legend)</em></p>
...
<p align="center"><em>DNase-seq and ATAC-seq chromatin accessibility experiments (Click the figure to see detailed legend)</em></p>
...
<p align="center"><em>The ENCODE data cube (Click the figure to see detailed legend)</em></p>
...
<p align="center"><em>Schematic of the neural network architecture of the BPNet model family (Click the figure to see detailed legend)</em></p>
...
<p align="center"><em>The ENCODE GRAMMAR resource transforms the extensive ENCODE compendium of genome-wide biochemical profiling experiments into predictive models and interpretable regulatory sequence annotations (Click the figure to see detailed legend)</em></p>
...
<p align="center"><em>Train a sequence-to-profile deep learning model (Click the figure to see detailed legend)</em></p>
...
<p align="center"><em>Predict the biochemical effect of unseen sequences and genetic variants (Click the figure to see detailed legend)</em></p>
...
<p align="center"><em>Separate biological signal from assay-specific sequence bias (Click the figure to see detailed legend)</em></p>
...
<p align="center"><em>Estimate the contribution of each base in a query DNA sequences to a model’s prediction of biochemical activity (Click the figure to see detailed legend)</em></p>
...
<p align="center"><em>Discover recurring predictive sequence motifs (Click the figure to see detailed legend)</em></p>
...
<p align="center"><em>Map predictive motif instances  (Click the figure to see detailed legend)</em></p>
...
<p align="center"><em>Unify motifs across models (Click the figure to see detailed legend)</em></p>
...
<p align="center"><em>A distal enhancer of the MYC gene in K562 leukemia cells (Click the figure to see detailed legend)</em></p>
...
<p align="center"><em>Observed and ChromBPNet-predicted chromatin-accessibility profiles at the *MYC* enhancer (Click the figure to see detailed legend)</em></p>
...
<p align="center"><em>Bias-corrected ChromBPNet accessibility profiles at the *MYC* enhancer (Click the figure to see detailed legend)</em></p>
...
<p align="center"><em>Highly concordant sequence-contribution maps reveal shared regulatory features at the *MYC* enhancer (Click the figure to see detailed legend)</em></p>
...
<p align="center"><em>TF ChIP–seq BPNet models link ChromBPNet motif instances to specific TFs at the *MYC* enhancer (Click the figure to see detailed legend)</em></p>
